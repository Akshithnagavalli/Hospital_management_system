...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-light fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.jsp"><img src="img/logo.jpg" width="150px" height="70px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-1 mb-lg-0">
                <c:if test="${empty userObj}">
                    ...
                    <li class="nav-item"><a class="nav-link active text-dark fs-5 me-2" aria-current="page" href="#contact-us">Contact</a></li>
                ...
                <c:if test="${not empty userObj}">
                    <li class="nav-item"><a class="nav-link active text-dark fs-5 me-2" aria-current="page" href="index.jsp">HOME</a></li>
                    <li class="nav-item"><a class="nav-link active text-dark fs-5 me-2" aria-current="page" href="about_us.jsp">ABOUT US</a></li>
                    <li class="nav-item"><a class="nav-link active text-dark fs-5 me-2" aria-current="page" href="user_appointment.jsp">BOOK APPOINTMENT</a></li>
                    <li class="nav-item"><a class="nav-link active text-dark fs-5 me-2" aria-current="page" href="view_appointment.jsp">VIEW APPOINTMENT</a></li>

                    <div class="dropdown">
                        <button class="btn btn-info dropdown-toggle fs-5" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="width:140px;margin-right:10px;">
